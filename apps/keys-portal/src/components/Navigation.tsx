...
import { Key, Lock, KeyRound, ScrollText, Wrench, Layers } from 'lucide-react'
    ...
    <nav className="bg-card border-b border-border mb-8">
      <div className="container mx-auto px-4">
        <div className="flex items-center space-x-1">
          ...
          <Button
            variant={location.pathname === '/key-bundles' ? 'default' : 'ghost'}
            asChild
            className="gap-2"
          >
            <Link to="/key-bundles">
          ...
          <Button
            variant={
              location.pathname === '/activity-log' ? 'default' : 'ghost'
            }
            asChild
            className="gap-2"
          >
