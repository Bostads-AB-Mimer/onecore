...
import { rentalObjectSearchService, RentalObjectSearchResult } from "@/services/api/rentalObjectSearchService";
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-3">
            <div className="space-y-1">
              <Label htmlFor="keyName" className="text-xs">Nyckelnamn *</Label>
              <Input
                id="keyName"
                className="h-8"
            ...
            <div className="space-y-1">
              <Label htmlFor="keyType" className="text-xs">Typ *</Label>
              <Select
            ...
            <div className="space-y-1">
              <Label htmlFor="keySequenceNumber" className="text-xs">Löpnummer</Label>
              <Input
          ...
          <div className="space-y-3">
            <div className="space-y-1 relative">
              <Label htmlFor="rentalObject" className="text-xs">Objekt</Label>
            ...
            <div className="space-y-1">
              <Label htmlFor="keySystemName" className="text-xs">Låssystem</Label>
              <Input
                id="keySystemName"
                className="h-8"
            ...
            <div className="space-y-1">
              <Label htmlFor="flexNumber" className="text-xs">Flexnr</Label>
              <Input
                id="flexNumber"
                type="number"
                className="h-8"
