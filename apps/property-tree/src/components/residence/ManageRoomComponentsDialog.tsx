...
export const ManageRoomComponentsDialog = ({
  ...
  // Query for components in this room
          ...
          <Tabs defaultValue="installera" className="w-full">
            ...
            <TabsContent value="installera">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {installationMode === 'existing' && selectedInstanceId && (
                  <div className="space-y-4 border-t pt-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <Label htmlFor="serialNumber-existing">
                          Serienummer
                        </Label>
                        <Input
                ...
                {/* Pricing Information (editable in 'existing' mode) */}
                {installationMode === 'existing' && selectedInstanceId && (
                  <div className="space-y-4 border-t pt-4">
                    <h3 className="font-medium">
                      Prisinformation (skrivskyddad)
                    </h3>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          value={formData.ncsCode}
                          onChange={(e) =>
                            handleChange('ncsCode', e.target.value)
                          }
