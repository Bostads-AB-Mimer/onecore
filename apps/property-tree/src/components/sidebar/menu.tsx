...
function createForwardedComponent<T extends React.ElementType, P extends object = {}>(
  displayName: string,
  render: React.ForwardRefRenderFunction<React.ElementRef<T>, React.PropsWithoutRef<React.ComponentProps<T> & P>>
) {
...
export const SidebarGroupLabel = createForwardedComponent<'div', { asChild?: boolean }>(
  'SidebarGroupLabel',
...
export const SidebarGroupAction = createForwardedComponent<'button', { asChild?: boolean }>(
  'SidebarGroupAction',
  ({ className, asChild = false, ...props }, ref) => {
...
export const SidebarMenuAction = createForwardedComponent<'button', { asChild?: boolean; showOnHover?: boolean }>(
  'SidebarMenuAction',
...
export const SidebarMenuSkeleton = createForwardedComponent<'div', { showIcon?: boolean }>(
  'SidebarMenuSkeleton',
...
export const SidebarMenuSubButton = createForwardedComponent<'a', {
  asChild?: boolean
  size?: 'sm' | 'md'
  isActive?: boolean
}>(
