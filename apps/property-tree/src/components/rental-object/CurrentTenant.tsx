...
import { LeaseInfo } from '../../features/residences/components/LeaseInfo'
import { TenantCard } from '../../features/residences/components/TenantCard'
        ...
        <div className="space-y-6">
          {lease.tenants?.map((tenant, i) => (
            <div key={tenant.contactCode}>
              {i > 0 && <Separator />}
              <TenantCard lease={lease} tenant={tenant} />
            </div>
          ))}
        </div>
      </div>
