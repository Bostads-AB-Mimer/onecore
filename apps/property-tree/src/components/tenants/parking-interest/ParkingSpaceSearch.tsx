...
//   const { data: parkingSpaces = [], isLoading } =
//     useParkingSpaceListings('published')
...
//     const matchesArea =
//       !areaFilter || areaFilter === 'all' || space.area === areaFilter

//     const matchesRent =
//       !maxRentFilter ||
//       isNaN(parseInt(maxRentFilter)) ||
...
//             const isSelected = selectedParkingSpaces.some(
//               (s) => s.id === space.id
//             )
//             return (
//               <Card
