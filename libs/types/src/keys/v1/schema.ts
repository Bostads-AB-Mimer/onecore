...
export const LogSchema = z.object({
  ...
  eventTypeLabel: z.string().optional(), // Swedish translation (e.g., "Skapad", "Uppdaterad")
  objectType: z.enum([
    'key',
    'keySystem',
    'keyLoan',
  ...
  objectTypeLabel: z.string().optional(), // Swedish translation (e.g., "Nyckel", "Nyckelsystem")
