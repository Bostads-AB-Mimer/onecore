...
- Det här steget skickar bara en **signeringsbegäran** — avtalet är inte uppsagt förrän hyresgästen faktiskt signerar med BankID. Själva stegövergången i Tenfast (från `preTermination` till `terminationScheduled`) styrs av Tenfast internt och är inte synlig i den här kodbasen — men när den är klar anropar Tenfast tillbaka till OneCore för att be oss skicka ett bekräftelsemejl, se [Tenfast Bekräftar Uppsägning av Bilplats](./DOCS_Send_Lease_Termination_Confirmation.md).
