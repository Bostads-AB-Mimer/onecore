...
- Det här steget skickar bara en **signeringsbegäran** — avtalet är inte uppsagt förrän hyresgästen faktiskt signerar med BankID. Vad som händer i Tenfast efter signering (övergång från `preTermination` till `terminationScheduled`) styrs av Tenfast internt och är inte synligt i den här kodbasen.
